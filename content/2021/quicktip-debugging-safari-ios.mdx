...
![Chrome's device toolbar](/images/quicktip-debugging-safari-ios/chrome-device-toolbar.png)
...
![Safari - Enter Responsive Design Mode menu item](/images/quicktip-debugging-safari-ios/safari-rdm-menu-item.png)

![Safari's Responsive Design Mode view](/images/quicktip-debugging-safari-ios/safari-rdm-view.png)
